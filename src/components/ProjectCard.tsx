...
export default function ProjectCard({ project, index }: ProjectCardProps) {
  ...
  return (
    ...
    >
      <div
        className="h-full p-6 rounded-xl border border-transparent group-hover:border-[color-mix(in_oklch,var(--color-primary)_30%,transparent)]
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm/relaxed mb-4 text-gray-400 line-clamp-2">
            {project.description}
          </p>
